...
const Contact: React.FC = () => {
  ...
  const schema = yup.object().shape({
    ...
    subject: yup.string().required("Esse campo é obrigatório"),
  ...
  async function onSubmitHandler<SubmitHandler, FormValues>(
    data: FormValues
  ): Promise<void> {
    try {
      setLoading(true);
  ...
  return (
    <React.Fragment key="key">
      ...
      >
        ...
        >
          <Box p={4}>
            <FormHeader heading="Contato" text="Detalhe o seu problema" />
